...
//     337 Undirected, weighted edges (distance in km), no loops, allow multi-edges.
//   - BuildFullUkraineGraph - multimodal (weighted, allow multi-edges, mixed directedness) 764 edges graph
//
...
//
//	RoadGraph: vertices=92, edges=337
//
...
//	After filtering ≤300 km: edges=287
//
//	FullGraph: vertices=92, edges=737
//
//	All 51 Neighbors of Kyiv in FullGraph:
//	  Kaniv(125.4 km) Kremenchuk(297.1 km) Berdychiv(188.4 km) Lutsk(423.5 km) Lviv(537.7 km) Odesa(507.7 km) Poltava(348.8 km) Rivne(347.8 km) Sumy(351.3 km) Uman(219.1 km) Vinnytsia(229.4 km) Zhytomyr(154.2 km) Myrhorod(207.9 km) Nizhyn(129.0 km) Bila_Tserkva(88.3 km) Romny(195.0 km) Bucha(27.8 km) Cherkasy(180.3 km) Chernihiv(147.5 km) Chernobyl(158.0 km) Boryspil(34.6 km) Kaniv(125.4 km) Khmelnytskyi(318.9 km) Kropyvnytskyi(286.6 km) Bila_Tserkva(88.3 km) Boryspil(34.6 km) Brovary(22.7 km) Kharkiv(489.0 km) Lviv(569.0 km) Poltava(348.8 km) Rivne(347.8 km) Sumy(351.3 km) Vinnytsia(229.4 km) Zhytomyr(154.2 km) Brovary(22.7 km) Myrhorod(207.9 km) Nizhyn(129.0 km) Bucha(27.8 km) Cherkasy(180.3 km) Bila_Tserkva(88.3 km) Boryspil(34.6 km) Brovary(22.7 km) Kharkiv(489.0 km) Lviv(569.0 km) Poltava(348.8 km) Rivne(347.8 km) Sumy(351.3 km) Vinnytsia(229.4 km) Zhytomyr(154.2 km) Chernihiv(147.5 km) Chernobyl(108.4 km)
//	CloneEmpty: vertices=92, edges=0
//	After filtering ≤300 km: edges=647
package main
...
func main1() {
	...
	fmt.Printf("\nRoadGraph: vertices=%d, edges=%d\n", roadG.VertexCount(), roadG.EdgeCount())
	...
	fmt.Printf("\nFullGraph: vertices=%d, edges=%d\n", fullG.VertexCount(), fullG.EdgeCount())
...
func BuildUkraineRoads() *core.Graph {
	g := core.NewGraph(core.WithWeighted(), core.WithMultiEdges()) // weighted graph
...
func BuildFullUkraineGraph() *core.Graph {
	...
	// add rails as 200x2 parallel edges
