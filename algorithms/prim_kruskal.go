...
// Returns MST edges in selection order, total weight, or an error.
//
// Complexity: O(E log V), Memory: O(E)
...
// Returns MST edges in ascending-weight order, total weight, or an error.
//
// Complexity: O(E log V + α(V)·E), Memory: O(E + V)
